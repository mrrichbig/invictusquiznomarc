            ...
            <div className="relative animate-cyber-scale-in delay-cyber-500">
              ...
              >
                ...
                <div className="flex items-center justify-center relative z-10">
                  <Zap
                    className={`${isMobile ? "mr-2 h-5 w-5" : "mr-4 h-6 w-6"} text-red-400 transition-all duration-300 group-hover:animate-cyber-typing flex-shrink-0`}
                  />
                  <span className={`tracking-wide ${isMobile ? "text-center leading-tight" : ""}`}>
                    {isMobile ? "INICIAR TESTE INVICTUS" : "INICIAR O TESTE INVICTUS"}
                  </span>
                  <Crown
                    className={`${isMobile ? "ml-2 h-5 w-5" : "ml-4 h-6 w-6"} text-red-400 transition-all duration-300 group-hover:animate-cyber-typing flex-shrink-0`}
                  />
                </div>
              </Button>
            </div>
